...
#### ***Віпдвовідь:*** Для компіляції та запуску програми написаної мовою C# в середовищі .NET Core необхідно виконати наступні команди в командному рядку:
1. Відкрити командний рядок або термінал.
